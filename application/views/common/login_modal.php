                    ...
                    <div class="col-md-11">
                        <div class="gorm-group">
                            <div class="row login-content">
                                ...
                                <div class="col-md-5">
                                    <label for="First Name">First Name <span class="pull-right text-right">:</span> </label>
                                </div>
                                <div class="col-md-7">
                                ...
                                <div class="col-md-5">
                                    <label for="Last Name">Last Name <span class="pull-right text-right">:</span> </label>
                                </div>
                                <div class="col-md-7">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <div class="forget-password">
                                        <a href="<?php echo base_url()."user/register" ?>" class="pull-left">Sign In</a>
                                        <a href="<?php echo base_url()."user/change_password" ?>" class="pull-right">Forget Password</a>
                                    </div>
