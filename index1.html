            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                        <div class="logo">
                            <a href="index.html">
                                <img src="images/logo.png" alt="Forex Cash Book | Forex Rebate | GlobeGain Corp" class="logo-img">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 col-sm-4 col-xs-4">
                        <div class="login-register">
                            <ul class="nav navbar-nav pull-right">
                                <li><a href="" class="btn btn-1">Login</a></li>
            ...
            <nav class="navbar navbar-default">
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand" href="#"> <i class="icon icon-home"></i> Home </a>
                    </div>

                    <!-- Collect the nav links, forms, and other content for toggling -->
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            <li><a href="#">Forex Rebates </a></li>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="copy-right">
                            <p>© 2011 - 2015 Globe Gain Corp. All rights reserved</p>
                        </div>
                    </div>
                    <div class="col-md-5">
                        <div class="terms-condition text-center">
                            <ul>
